...
// 难度参数（经 tools/balance.mjs 校准：贪心机器人有道具通关率 daily1/easy≈100%、normal≈80%、hard≈46%、daily2≈22%）
...
export const LEVELS = {
  ...
  daily2: { name: '第 2 关', kinds: 16, perKind: 12, cols: 7, rows: 8, layers: 12, stackSize: 12, taper: 0.12, shrink: 0.2, baseInset: 0, kOpen: 3, pContinue: 0.35, pDig: 0.8, candidates: 8, solvable: true },
  ...
  normal: { name: '普通', kinds: 13, perKind: 9, cols: 7, rows: 8, layers: 9, stackSize: 9, taper: 0.15, shrink: 0.3, baseInset: 0, kOpen: 2, pContinue: 0.45, pDig: 0.8, candidates: 3, solvable: true },
  hard: { name: '困难', kinds: 15, perKind: 12, cols: 7, rows: 8, layers: 11, stackSize: 12, taper: 0.12, shrink: 0.22, baseInset: 0, kOpen: 3, pContinue: 0.35, pDig: 0.8, candidates: 3, solvable: true },
